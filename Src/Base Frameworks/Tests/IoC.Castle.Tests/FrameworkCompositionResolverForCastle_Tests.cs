...
{
	[TestClass]
	public class FrameworkCompositionResolverForCastle_Tests : UnitTestBase
	{
		...
		[Description("FrameworkCompositionResolverForCastle 의 Contract/Dependency 메서드 호출 테스트, 오류가 발생하지 않으면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 DefaultValueAttribute 을 통해 ProertyInjection 테스트, 오류가 발생하지 않고 DefaultValue 값과 동일하면 통과")]
		public void FrameworkCompositionResolverForCastle_PropertyInjection_By_DefaultValue()
		{
			FrameworkContainerForCastle container = CompositionTheTypes(typeof(MockClass_PropertyInjection_DefaultValue).ToEnumerable().ToArray());
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 DependencyInjectionAttribute.DefaultValue를 통해 PropertyInjection 테스트, 오류가 발생하지 않고 DefaultValue 값과 동일하면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 계약 타입의 PropertyInjection테스트, 오류가 발생하지 않으면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 프로퍼티 계약 키 값 별로 값을 가져오는지 테스트, 각 키 값이 일치하면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 서로 다른 계약 키 값의 프로퍼티에 DependencyInjection으로 다른 키 계약을 가져오는 테스트, 오류가 발생하지 않으면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 DefaultValue를 이용한 ConstructorInjection 테스트, 오류가 발생하지 않고 Name,Age 값이 초기값과 동일하면 통과")]
		public void FrameworkCompositionResolverForCastle_ConstructorInjection_By_DefaultValue()
		{
			var types = new Type[]
			{
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 DependencyInjection.DefaultValue를 이용한 ConstructorInjection 테스트, 오류가 발생하지 않고 Name,Age 값이 초기값과 동일하면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 계약된 ConstructorInjection을 이용한 테스트, 오류가 발생하지 않고 값이 동일하면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 계약된 키값을 이용한 Injection 테스트, 오류가 발생하지 않고, Unique값이 주입된 키값이 a이면 통과")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 MethodInjection을 DefaultValue로 수행하여 테스트, 오류가 발생하지 않고 Name,Age 값이 동일하면 통과")]
		[ExpectedException(typeof(NotSupportedException), "현재 FrameworkCompositionResolverForCatle 은 Nethod Injection 오류를 지원하지 않아 예외가 발생해야 함")]
		public void FrameworkCompositionResolverForCastle_MethodInjection_By_DefaultValue()
		{
			var types = new Type[]
			{
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 DependencyInjectionAttribute.DefaultValue로 수행하여 테스트, 오류가 발생하지 않고 Name,Age 값이 동일하면 통과")]
		[ExpectedException(typeof(NotSupportedException), "현재 FrameworkCompositionResolverForCatle 은 Nethod Injection 오류를 지원하지 않아 예외가 발생해야 함")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 계약을 MethodInjection 수행 테스트, 오류가 발생하지 않고 계약된 값과 동일하면 통과")]
		[ExpectedException(typeof(NotSupportedException), "현재 FrameworkCompositionResolverForCatle 은 Nethod Injection 오류를 지원하지 않아 예외가 발생해야 함")]
		...
		[TestCategory("BVT Function"), TestMethod]
		[Description("FrameworkCompositionResolverForCastle의 계약된 MethodInjection을 키값으로 주입하는 테스트, 오류가 발생하지 않고 키 값이 동일하면 통과")]
		[ExpectedException(typeof(NotSupportedException), "현재 FrameworkCompositionResolverForCatle 은 Nethod Injection 오류를 지원하지 않아 예외가 발생해야 함")]
