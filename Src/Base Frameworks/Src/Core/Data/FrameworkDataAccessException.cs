...
{
	public class FrameworkDataAccessException : FrameworkException
	{
		/// <summary>	
		/// 	<see cref="FrameworkException"/> 인스턴스를 초기화 시킵니다. 
		/// </summary>
		protected FrameworkDataAccessException()
			: base()
		{
		}
		...
		public FrameworkDataAccessException(string message)
			: base(message)
		{
		}
		...
		public FrameworkDataAccessException(string format, params string[] arg)
		...
		public FrameworkDataAccessException(string message, Exception innerException)
		...
		/// <param name="format">	오류 메시지의 포멧입니다.. </param>
		/// <param name="arg">	오류 메시지의 포멧으로 전달되는 매개 변수 입니다. </param>
		public FrameworkDataAccessException(Exception innerException, string format, params string[] arg)
